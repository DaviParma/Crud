...
const Table = () => {
    ...
    useEffect(() => {
        async function getData() {
          const urlget = `http://localhost:5500/users`
          try {
        ...
        return (
          <Fade triggerOnce={true}>
            <div className='container mx-auto flex items-center justify-center h-screen '>
              <div className="shadow-lg rounded-xl p-5 bg-slate-50 ">
                <div>
                  <h1 className='text-red-500 text-center text-5xl font-medium py-5 max-msm:text-4xl'>There is no user created in the database</h1>
        ...
        <Fade triggerOnce={true}>
          <div className='container mx-auto flex h-screen items-center justify-center'>
              ...
              <div className='sm:hidden h-[700px]'>
                ...
                <div class="grid grid-flow-col-dense py-20 ">
                  ...
                  <div className='bg-white text-center'>
                    ...
                    <p className='break-all border-b-2 border-slate-200  py-5 px-5 max-msm:px-0'>{x.email}</p>
